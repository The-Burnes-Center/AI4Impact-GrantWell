...
│
└── themed/               # Auto-generated Cloudscape theme (do not edit)
```
...
| `npm run build:theme` | Generate Cloudscape theme |
...
The `themed/` folder contains auto-generated Cloudscape design system files. **Do not edit manually** - they are generated by:
