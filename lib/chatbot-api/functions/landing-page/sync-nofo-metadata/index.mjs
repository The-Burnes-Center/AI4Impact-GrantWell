 ...
 * 2. summary.json (created by the NOFO processing pipeline)
 * 3. questions.json (optional but preferred - created by the NOFO processing pipeline)
 * 
    ...
    for (const folderName of allFolders) {
      ...
      try {
        ...
        if (existingItem.Item) {
          // Update existing item, preserve created_at and grant_type if not in summary
          ...
          item = {
            ...
            grant_type: summary.grant_type || existing.grant_type || null,
