 ...
 * whose application deadline has passed. It includes a grace period (default 7 days)
...
export const handler = async (event) => {
  ...
  const gracePeriodDays = parseInt(process.env.GRACE_PERIOD_DAYS || '7', 10); // Default 7 days
