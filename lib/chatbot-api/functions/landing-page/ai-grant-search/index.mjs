...
export const handler = async (event) => {
  ...
  try {
    ...
    // Record the search for analytics (popular-queries). Track the raw query the user typed.
    // Best-effort; failures are swallowed by the helper and never affect search results.
    if (claims.sub) {
