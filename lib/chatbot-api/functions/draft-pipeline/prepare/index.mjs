...
export const handler = async (event) => {
  const { jobId, query, documentIdentifier, projectBasics, questionnaire, sessionId, userId, userState } = event;

  console.log(`Prepare: job ${jobId} for "${documentIdentifier}" (session ${sessionId})`);
