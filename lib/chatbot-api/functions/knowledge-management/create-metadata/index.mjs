...
export const handler = async (event) => {
  ...
  // Automatically trigger KB sync after creating metadata (similar to NOFO uploads)
  // Only sync if we actually created metadata files
  if ((metadataCreatedForUserDocs || metadataCreatedForNofos) && process.env.SYNC_KB_FUNCTION_NAME) {
    try {
      ...
      // Non-critical error - metadata was created successfully
    }
  }
