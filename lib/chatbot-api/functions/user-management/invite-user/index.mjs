 ...
 * It checks if the requester can access admin features before allowing the operation.
 */
...
export const handler = async (event) => {
  // Developers inherit admin capabilities for management operations.
  try {
  ...
  try {
    // Create the user in Cognito with default message
