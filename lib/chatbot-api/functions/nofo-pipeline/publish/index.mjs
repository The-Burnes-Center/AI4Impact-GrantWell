...
export const handler = async (event) => {
  ...
  // Create metadata file for KB filtering. scope/state come from DDB so we
  // don't lose them when publish overwrites a sidecar that was written
  // earlier in the upload flow.
