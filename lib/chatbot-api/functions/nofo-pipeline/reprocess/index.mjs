...
export const handler = async (event) => {
  ...
  // Reprocessing re-runs the pipeline for this NOFO; state admins may only reprocess their own.
  const denied = await assertCanEditNofoOr403(event, scopeDeps, metadataTable, nofoName);
