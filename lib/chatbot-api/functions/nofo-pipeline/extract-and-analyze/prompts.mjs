...
export const RETRY_PROMPT_PREFIX = `A quality auditor reviewed your previous extraction of this NOFO and found issues. Re-extract the document, paying close attention to the feedback below before proceeding.
