...
- ALL times MUST be converted to Eastern Standard Time (EST/ET). If a deadline is listed in UTC or another timezone, convert it to EST and display as EST
- Descriptions must include the specific date/time in EST when available, the submission method, and consequences of missing the deadline
...
- Application submission deadline (exact date, time in EST)
