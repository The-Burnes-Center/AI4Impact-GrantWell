...
// Usage: node scripts/check-vendor.mjs <instance dir>
...
if (!dir) {
  console.error("Usage: check-vendor.mjs <instance dir>");
  process.exit(2);
}
...
if (problems.length) {
  ...
  console.error("Re-run scripts/pack.sh, or `npm install ./vendor/<file>.tgz` in the instance, and commit both.");
  process.exit(1);
}
